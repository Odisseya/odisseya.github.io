...
$megamenuSubCatItemClass = 'bd-sub-item bd-mega-item  bd-menuitem-12';
...
ob_start();
?>
<div class="bd-menuitem-8 bd-sub-item bd-mega-item  bd-menuitem-9 separated-item-2">
...
ob_start();
?>
<li class=" bd-menuitem-7 bd-toplevel-item bd-submenu-icon-only deeper parent">
<?php 
...
<li class="bd-menuitem-7 bd-toplevel-item bd-submenu-icon-only deeper parent item-124 men">
<a href="#"><span><?php echo $module->title; ?></span></a>


<div class="bd-menu-4-popup"><ul class=" bd-menu-4 ">	
<ul class=" bd-menu-3 nav navbar-right nav-pills<?php echo $class_sfx;?>" <?php echo $tag_id; ?>>
        ...
        if ($item->shallower) {
            if (($item->level - $item->level_diff) <= $limit) {
                if ($megaMenuTags) {
                    ...
                    echo '</li>' . str_repeat('</ul></div></li></div>', $item->level_diff);
                }
                $skip = false;
            }
        }
...
ob_start();
?>
<li class=" bd-menuitem-8 bd-sub-item">
