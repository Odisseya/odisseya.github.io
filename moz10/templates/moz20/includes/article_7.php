<?php function article_7($data) {
    ...
    ?>
        ...
        <article class=" bd-article-7"<?php echo $attr; ?><?php echo $postIdClass; ?>>
            <?php
    $attr = '';
...
?>
<div class=" bd-postcontent-7 bd-tagstyles bd-custom-blockquotes bd-bootstrap-img bd-img-responsive bd-custom-bulletlist bd-custom-orderedlist bd-custom-table  bd-contentlayout-offset" <?php echo $attr; ?> itemprop="articleBody">
