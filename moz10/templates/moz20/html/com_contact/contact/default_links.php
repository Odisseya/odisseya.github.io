...
<?php if ($this->params->get('presentation_style') == 'sliders') : ?>
    ...
    <div class="collapse">
        <div class=" bd-container-43 bd-tagstyles bd-bootstrap-img bd-img-responsive bd-bootstrap-tables bd-table-striped bd-table-bordered bd-table-hover bd-table-condensed bd-table-responsive clearfix">
<?php endif; ?>
