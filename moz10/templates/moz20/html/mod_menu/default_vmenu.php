...
<div class=" bd-vmenu-1" data-responsive-menu="true" data-responsive-levels="expand on click">
    <div class=" bd-block-2 bd-own-margins <?php echo $params->get('moduleclass_sfx'); ?>">
        <?php if ($hasCaption) : ?>
        <div class=" bd-blockheader bd-tagstyles bd-bootstrap-img bd-img-responsive bd-bootstrap-tables bd-table-striped bd-table-bordered bd-table-hover bd-table-condensed bd-table-responsive">
            <h4><?php echo $caption; ?></h4>
        </div>
        <?php endif; ?>
        <div class=" bd-blockcontent bd-tagstyles bd-bootstrap-img bd-img-responsive bd-bootstrap-tables bd-table-striped bd-table-bordered bd-table-hover bd-table-condensed bd-table-responsive shape-only">
