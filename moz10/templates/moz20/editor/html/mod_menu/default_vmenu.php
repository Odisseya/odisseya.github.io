...
$showAll = 'one level' != 'expand on hover';
$itemLI = '<li class="">';
...
<div class="data-control-id-2779 bd-vmenu-1" data-responsive-menu="true" data-responsive-levels="expand on click">
    <div class="data-control-id-2778 bd-block-2 bd-own-margins <?php echo $params->get('moduleclass_sfx'); ?>">
        <?php if ($hasCaption) : ?>
        <div class="data-control-id-2745 bd-blockheader bd-tagstyles bd-bootstrap-img bd-img-responsive bd-bootstrap-tables bd-table-striped bd-table-bordered bd-table-hover bd-table-condensed bd-table-responsive">
            <h4><?php echo $caption; ?></h4>
        </div>
        <?php endif; ?>
        <div class="data-control-id-2777 bd-blockcontent bd-tagstyles bd-bootstrap-img bd-img-responsive bd-bootstrap-tables bd-table-striped bd-table-bordered bd-table-hover bd-table-condensed bd-table-responsive shape-only">
...
ob_start();
?>
<li class="data-control-id-200676 bd-menuitem-23">
<?php 
$menuStartItem = ob_get_clean();
ob_start();
?>

<ul class="data-control-id-200675 bd-menu-23 nav nav-pills<?php echo $class_sfx;?>" <?php echo $tag_id; ?>>
<?php
$bVMenu = ob_get_clean();
$eVMenu = '</ul>';
?>
...
ob_start();
?>
<li class="data-control-id-200695 bd-menuitem-24">
