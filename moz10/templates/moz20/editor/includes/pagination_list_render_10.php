...
function pagination_list_render_10($list)
{
    ...
    ob_start();
?>
    <ul class="data-control-id-1460390 bd-pagination-11 pagination">
    <?php if ($list['start']['active']) : ?>
        <li class="data-control-id-1460609 bd-paginationitem-11">
    ...
    <?php foreach($list['pages'] as $page) : ?>
        <?php if (!$page['active']) : ?>
            <li class="active data-control-id-1460609 bd-paginationitem-11">
        <?php else : ?>
            <li class="data-control-id-1460609 bd-paginationitem-11">
        <?php endif; ?>
