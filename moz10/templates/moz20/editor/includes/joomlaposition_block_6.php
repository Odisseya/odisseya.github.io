<?php
function joomlaposition_block_6($caption, $content, $classes = '', $id = '', $extraClass = '')
{
    ...
    ob_start();
    ?>
    <div class="data-control-id-1367153 bd-block bd-own-margins <?php echo $classes; ?>" <?php echo $id; ?>>
    <?php if ($hasCaption) : ?>
    
    <div class="data-control-id-1367177 bd-blockheader bd-tagstyles bd-bootstrap-img bd-img-responsive bd-bootstrap-tables bd-table-striped bd-table-bordered bd-table-hover bd-table-condensed bd-table-responsive">
