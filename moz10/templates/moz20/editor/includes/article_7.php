...
?>
<div class="data-control-id-1258775 bd-postcontent-7 bd-tagstyles bd-custom-blockquotes bd-bootstrap-img bd-img-responsive bd-custom-bulletlist bd-custom-orderedlist bd-custom-table  bd-contentlayout-offset" <?php echo $attr; ?> itemprop="articleBody">
