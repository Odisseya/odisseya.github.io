...
$megamenuClass = 'bd-has-megamenu bd-megamenu bd-megamenu-sm';
$megamenuSubCatItemClass = 'bd-sub-item bd-mega-item data-control-id-1347919 bd-menuitem-12';
...
ob_start();
?>
<div class="bd-menuitem-8 bd-sub-item bd-mega-item data-control-id-1347896 bd-menuitem-9 separated-item-2">
...
$skip = false;
?>
<div class="data-control-id-1347447 bd-horizontalmenu-2 clearfix">
...
ob_start();
?>
<li class="data-control-id-1347930 bd-menuitem-7 bd-toplevel-item {submenu_icon_only}">
<?php 
$menuStartItem = ob_get_clean();
ob_start();
?>

<ul class="data-control-id-1347929 bd-menu-3 nav navbar-right nav-pills<?php echo $class_sfx;?>" <?php echo $tag_id; ?>>
<?php
$bHMenu = ob_get_clean();
$eHMenu = "</ul>";
?>
...
ob_start();
?>
<li class="data-control-id-1347952 bd-menuitem-8 bd-sub-item">
<?php $subMenuStartItem = ob_get_clean(); ?>
    ...
    if ($item->deeper) {
        ...
        <div class="bd-menu-4-popup<?php echo $item->megaclass && $item->level == 2 ? ' bd-megamenu-popup' : ''; ?>">
            ...
            <?php else : ?>
                <ul class="data-control-id-1347950 bd-menu-4 ">
            <?php endif; ?>
        <?php
    }
