<?php function article_2($data) {
    ...
    ?>
        ...
        <article class="data-control-id-2957 bd-article-2"<?php echo $attr; ?><?php echo $postIdClass; ?>>
            <h2 class="data-control-id-1423961 bd-postheader-15"  itemprop="name">
...
<?php endif; ?>
		...
		<div class="data-control-id-1464574 bd-layoutbox-47 bd-page-width  bd-no-margins clearfix">
    <div class="bd-container-inner">
        <?php if (isset($data['date-icons']) && count($data['date-icons'])) : ?>
<div class="data-control-id-1422964 bd-posticondate-20 bd-no-margins">
    <span class="data-control-id-1422963 bd-icon bd-icon-105"><span><?php
...
<div class="data-control-id-1464603 bd-posticonauthor-24 bd-no-margins">
    <span class="data-control-id-1464602 bd-icon bd-icon-168"><span><?php echo $data['author-icon']; ?></span></span>
</div>
<?php endif; ?>
	
		<?php if (isset($data['category-icon']) && strlen($data['category-icon'])) : ?>
<div class="data-control-id-1464631 bd-posticoncategory-27">
    <span class="data-control-id-1464630 bd-icon bd-icon-171"><span><?php echo $data['category-icon']; ?></span></span>
</div>
<?php endif; ?>
    </div>
</div>
...
<?php
    ...
    ?>
<div class="data-control-id-545466 bd-postimage-1 <?php echo $floatClass; ?>">
    
    <?php if (isset($image['link']) && $image['link'] !== '') : ?>
    <a href="<?php echo $image['link']; ?>">
        <?php endif; ?>
        <img src="<?php echo $image['image']; ?>" alt="<?php echo $image['alt']; ?>" class="data-control-id-545465   img-responsive" itemprop="image"/>
        <?php if (isset($image['link']) && $image['link'] !== '') : ?>
    </a>
    <?php endif; ?>
    
    <?php if ($caption): ?>
    <div class="data-control-id-1083477 bd-container-50 bd-tagstyles bd-bootstrap-img bd-img-responsive bd-bootstrap-tables bd-table-striped bd-table-bordered bd-table-hover bd-table-condensed bd-table-responsive ">
        <?php echo $caption; ?>
    </div>
    <?php endif; ?>
</div>
...
?>
<div class="data-control-id-1078 bd-postcontent-2 bd-tagstyles bd-custom-blockquotes bd-bootstrap-img bd-img-responsive bd-bootstrap-tables bd-table-striped bd-table-bordered bd-table-hover bd-table-condensed bd-table-responsive bd-contentlayout-offset" <?php echo $attr; ?> itemprop="articleBody">
    <?php if (isset($data['content']) && strlen($data['content'])):
		...
		<div class="data-control-id-1464678 bd-layoutbox-49 bd-page-width  bd-no-margins clearfix">
    <div class="bd-container-inner">
        <?php if (isset($data['tags-icon'])) : ?>
<div class="data-control-id-1464697 bd-posticontags-30 bd-no-margins">
            <span class="data-control-id-1464696 bd-icon bd-icon-174"><span>
...
<a class="bd-postreadmore-2 bd-button-47 data-control-id-1464712" href="<?php echo $data['readmore-link'] ?>" >
