...
?>
		...
		<section class=" bd-section-2 bd-page-width bd-tagstyles bd-bootstrap-img bd-img-responsive bd-bootstrap-tables bd-table-striped bd-table-bordered bd-table-hover bd-table-condensed bd-table-responsive " id="section4" data-section-title="Two Columns With Header">
    <div class="bd-container-inner bd-margins clearfix">
...
?>
    ...
    <?php
echo <<<'CUSTOM_CODE'
121374, Россия, г. Москва, Можайское шоссе, д.10 <br>&nbsp;На&nbsp;связи 24/7, без праздников и выходных.1
CUSTOM_CODE;
?>
</p>
    </div>
