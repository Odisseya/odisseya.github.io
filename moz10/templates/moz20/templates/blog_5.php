...
<img class="   img-responsive" <?php echo $logoSrc; ?> alt="<?php echo $sitename; ?>">
 ...
 col-sm-6">
    ...
    <?php
echo <<<'CUSTOM_CODE'
<span class="roistat-phone"><a href="tel:+7(495)788-03-03" draggable="false" class="roistat-phone">+7(495)788-03-03</a>&nbsp;</span><br> г. Москва, Можайское шоссе, д.10
</span><br>На связи 24/7&nbsp;
CUSTOM_CODE;
?>
</p>
    </div>
...
?>
 ...
 <?php renderTemplateFromIncludes('sidebar_area_4'); ?>
    ...
    $document->view->componentWrapper('blog_9');
...
?>
    ...
    <?php
echo <<<'CUSTOM_CODE'
121374, Россия, Москва, улица Габричевского, 5к10<br>&nbsp;На&nbsp;связи 24/7, без праздников и выходных.
CUSTOM_CODE;
?>
</p>
    </div>
    ...
    <?php
echo <<<'CUSTOM_CODE'
<span class="roistat-phone"><a href="tel:+7(495)788-03-03" draggable="false" class="roistat-phone">+7(495)788-03-03</a>&nbsp;</span><span class="roistat-phone"></span><br>На связи 24/7&nbsp;
CUSTOM_CODE;
?>
</p>
    </div>
