	 ...
	 *
        ...
        public function generateAdminLinks($sHtml, $sCss)
        {
               ...
               // $params->set('excludeJsComponents', array());
                ...
                $params->set('pro_cookielessdomain_enable', '0');
                $params->set('pro_lazyload', '0');
		$params->set('pro_optimizeCssDelivery_enable', '0');
			...
			$aLinks = $oParser->getReplacedFiles();
                        ...
                        $aLinks['lazyloadclass'] = array_filter(array_merge($aMatches[3], $aMatches[12]));
                        $aLinks['lazyload']      = array_merge($aMatches[7], $aMatches[16]);
                        ##</procode>##
                }
                catch (Exception $e)
                {
